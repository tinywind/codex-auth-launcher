...
INSTALL_ROOT="${CODEX_AUTH_LAUNCHER_INSTALL_ROOT:-$HOME/.local/share/codex-auth-launcher}"
BIN_DIR="${CODEX_AUTH_LAUNCHER_BIN_DIR:-$HOME/.local/bin}"
LEGACY_BLOCK_START="# >>> codex-auth-launcher >>>"
LEGACY_BLOCK_END="# <<< codex-auth-launcher <<<"
PATH_BLOCK_START="# >>> codex-auth-launcher path >>>"
PATH_BLOCK_END="# <<< codex-auth-launcher path <<<"
...
write_wrapper "$BIN_DIR/codex-auth-link" "$INSTALL_ROOT/link-global-auth.sh"
